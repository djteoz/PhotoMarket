...
import { Building2, FileText, CreditCard, MapPin, Mail, Phone } from "lucide-react";
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Форма собственности</p>
              ...
              <CardContent>
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium font-mono">312345678901234</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">АО «Тинькофф Банк»</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">БИК</p>
                    <p className="font-medium font-mono">044525974</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Расчётный счёт</p>
                    <p className="font-medium font-mono">40802810000000000000</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Корр. счёт</p>
                    <p className="font-medium font-mono">30101810145250000974</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="font-medium">123456, г. Москва, ул. Примерная, д. 1, кв. 1</p>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              <p className="text-sm text-amber-800">
                <strong>Важно:</strong> Платежи на сайте обрабатываются через сервис ЮKassa (ООО «ЮКасса»). 
                Мы не храним данные банковских карт на нашем сервере.
              </p>
            </div>
