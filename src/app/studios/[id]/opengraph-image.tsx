...
export default async function Image({ params }: { params: { id: string } }) {
  ...
  const avgRating = studio.reviews.length > 0
    ? (studio.reviews.reduce((sum, r) => sum + r.rating, 0) / studio.reviews.length).toFixed(1)
    : null;
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
          ...
          >
            ...
            {avgRating && (
              <div style={{ display: "flex", flexDirection: "column" }}>
                <span style={{ color: "#94a3b8", fontSize: "20px" }}>Рейтинг</span>
