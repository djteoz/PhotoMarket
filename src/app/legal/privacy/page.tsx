...
import { Shield, Eye, Database, Lock, Mail, Globe, Users, Trash2 } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import Link from "next/link";

export const metadata: Metadata = {
  title: "Политика конфиденциальности — PhotoMarket",
  description: "Политика обработки персональных данных на платформе PhotoMarket",
};
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card>
              <CardContent className="pt-6">
                <p className="text-slate-600 leading-relaxed">
                  Настоящая Политика конфиденциальности описывает, как PhotoMarket 
                  (далее — «Платформа», «мы», «нас») собирает, использует и защищает 
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-semibold mb-2">Данные, которые вы предоставляете:</h4>
                ...
                <div>
                  <h4 className="font-semibold mb-2">Данные, собираемые автоматически:</h4>
                  <ul className="list-disc list-inside text-slate-600 space-y-1">
                    <li>IP-адрес</li>
                    <li>Тип браузера и устройства</li>
                    <li>Данные об использовании сайта (просмотренные страницы)</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-slate-600">
                  ...
                  для маркетинговых целей. Данные могут быть переданы только:
                </p>
                <ul className="list-disc list-inside text-slate-600 space-y-2">
                  <li><strong>Clerk</strong> — для аутентификации пользователей</li>
                  <li><strong>Vercel</strong> — хостинг-провайдер</li>
                  <li><strong>Neon/PostgreSQL</strong> — хранение данных</li>
                  <li><strong>ЮKassa</strong> — обработка платежей (при оплате)</li>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-slate-600 mt-4">
                  ...
                  <a href="mailto:support@photomarket.tech" className="text-purple-600 hover:underline ml-1">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-slate-600">
                  ...
                  уведомим вас по электронной почте или через уведомление на сайте.
                </p>
              </CardContent>
            </Card>
