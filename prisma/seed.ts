  ...
  const studios = [
    {
      ...
      description:
        "Крупнейший комплекс фотостудий в Москве. Профессиональное оборудование Profoto, разнообразные интерьеры, циклорамы. Идеально для fashion-съемок и масштабных проектов.",
    ...
    },
    {
      ...
      description:
        "Атмосферные лофты в историческом центре Москвы. Кирпичные стены, высокие потолки, винтажная мебель. Прекрасный выбор для свадебных и семейных фотосессий.",
    ...
    },
    {
      ...
      description:
        "Интерьерная фотостудия с уникальными декорациями в стиле барокко и классицизма. Идеально для портретной съемки и love-story.",
    ...
    },
    {
      name: "Zavod Photo",
      description:
        "Индастриал пространство на территории бывшего завода. Огромные окна, бетонные стены, грузовой лифт. Подходит для видеопродакшна.",
    ...
    },
    {
      name: "Apriori Photo",
      description:
        "Современная студия с большим выбором бумажных фонов и профессиональным светом Profoto D2. Удобное расположение, гримерные места.",
    ...
    },
    {
      ...
      description:
        "Светлая студия с огромными окнами в пол. Минималистичный интерьер, много воздуха и света. Идеально для контент-съемки.",
