...
export const MOSCOW_STUDIOS: RealStudio[] = [
  {
    ...
    description:
      "Современная фотостудия в центре Москвы с 4 залами. Профессиональное оборудование Profoto, циклорамы, интерьерные локации. Идеально для fashion, beauty, предметной съёмки и видеопродакшена.",
    ...
    rooms: [
      {
        ...
        description:
          "Просторный зал 80м² с белой циклорамой 6x4м. Высота потолков 5м. Идеален для fashion и каталожной съёмки.",
        pricePerHour: 3500,
        area: 80,
      ...
      },
      {
        ...
        description:
          "Стильный лофт с кирпичной кладкой, большими окнами и винтажной мебелью. Естественный свет весь день.",
        pricePerHour: 2800,
        area: 60,
  ...
  },
  {
    name: "Studio 54",
    description:
      "Легендарная фотостудия на Красном Октябре. 6 уникальных залов с авторским дизайном. Работаем с 2010 года. Более 10 000 съёмок для ведущих брендов и журналов.",
    ...
    rooms: [
      {
        name: "Black Box",
        description:
          "Чёрный зал с возможностью полного затемнения. Идеален для контрастных съёмок, световых эффектов и видео.",
        pricePerHour: 4000,
        area: 100,
        hasNaturalLight: false,
        hasCyclorama: true,
      ...
      },
      {
        ...
        description:
          "Зал с панорамными окнами и видом на Москву-реку. Максимум естественного света для lifestyle съёмок.",
        pricePerHour: 3200,
        area: 70,
        hasNaturalLight: true,
        hasCyclorama: false,
      ...
      },
      {
        name: "Vintage Room",
        description:
          "Интерьерный зал в стиле ретро 60-х. Антикварная мебель, виниловые проигрыватели, аутентичный декор.",
        pricePerHour: 2500,
        area: 45,
        hasNaturalLight: true,
        hasCyclorama: false,
  ...
  },
  {
    name: "Photoplace",
    description:
      "Сеть фотостудий эконом-класса. Доступные цены без потери качества. 3 локации в Москве. Всё оборудование включено в стоимость аренды.",
    ...
    rooms: [
      {
        name: "Стандарт",
        description:
          "Компактный зал для портретной и предметной съёмки. Белый фон, базовое оборудование.",
        pricePerHour: 1200,
        area: 30,
        hasNaturalLight: false,
        hasCyclorama: false,
      ...
      },
      {
        name: "Про",
        description:
          "Зал с мини-циклорамой для fashion и каталогов. Расширенный набор света.",
        pricePerHour: 1800,
        area: 50,
        hasNaturalLight: false,
        hasCyclorama: true,
...
export const SPB_STUDIOS: RealStudio[] = [
  {
    name: "Nevsky Studio",
    description:
      "Премиальная фотостудия в историческом центре Петербурга. Высокие потолки, лепнина, арочные окна. Атмосфера дворцовых интерьеров для съёмок премиум-класса.",
    ...
    rooms: [
      {
        ...
        description:
          "Зал с 6-метровыми потолками, хрустальными люстрами и антикварной мебелью. Для свадеб и luxury съёмок.",
        pricePerHour: 5000,
        area: 120,
        hasNaturalLight: true,
        hasCyclorama: false,
      ...
      },
      {
        name: "Белая студия",
        description:
          "Современный минималистичный зал с U-образной циклорамой. Контраст классики и модерна.",
        pricePerHour: 3500,
        area: 80,
        hasNaturalLight: false,
        hasCyclorama: true,
  ...
  },
  {
    name: "Loft Ligovsky",
    description:
      "Индустриальный лофт в бывшем заводском здании. Кирпич, металл, панорамные окна. Популярная локация для клипов, рекламы и fashion.",
    ...
    rooms: [
      {
        name: "Main Hall",
        description:
          "Основной зал 200м² с 8-метровыми потолками. Для масштабных съёмок, мероприятий и видеопродакшена.",
        pricePerHour: 4500,
        area: 200,
        hasNaturalLight: true,
        hasCyclorama: false,
      ...
      },
      {
        name: "Corner Studio",
        description:
          "Угловой зал с двумя стенами окон. Мягкий рассеянный свет весь день.",
        pricePerHour: 2500,
        area: 60,
        hasNaturalLight: true,
        hasCyclorama: false,
...
export const OTHER_CITIES_STUDIOS: RealStudio[] = [
  {
    name: "Ural Photo",
    description:
      "Крупнейшая фотостудия Екатеринбурга. 5 залов на 1000м². Полный цикл услуг: аренда, фотографы, визажисты, продакшен.",
    ...
    rooms: [
      {
        name: "Циклорама 360°",
        description:
          "Уникальная круговая циклорама для съёмки автомобилей и крупных объектов.",
        pricePerHour: 3000,
        area: 150,
        hasNaturalLight: false,
        hasCyclorama: true,
  ...
  },
  {
    name: "Kazan Studio",
    description:
      "Современная студия в Казани. Европейское оборудование, уютная атмосфера. Работаем со свадьбами, портретами, каталогами.",
    ...
    rooms: [
      {
        ...
        hasCyclorama: true,
        images: [
          "https://images.unsplash.com/photo-1529335764857-3f1164d1cb24?w=800",
        ],
      ...
      },
      {
        name: "Dark Studio",
        description:
          "Тёмный зал для контрастных съёмок и световых экспериментов.",
        pricePerHour: 1500,
        area: 40,
        hasNaturalLight: false,
        hasCyclorama: false,
  ...
  },
  {
    name: "SouthLight",
    description:
      "Фотостудия у моря в Сочи. Открытая терраса с видом на горы, пляжные локации, студийные залы. Уникальное сочетание природы и студии.",
    ...
    rooms: [
      {
        name: "Терраса",
        description:
          "Открытая терраса 100м² с видом на море и горы. Для lifestyle и свадебных съёмок.",
        pricePerHour: 2000,
        area: 100,
        hasNaturalLight: true,
        hasCyclorama: false,
  ...
  },
  {
    ...
    description:
      "Фотохаб в центре Новосибирска. Коворкинг для фотографов, аренда залов, образовательные программы.",
    ...
    rooms: [
      {
        name: "Studio A",
        description:
          "Основной зал с циклорамой и полным набором студийного оборудования.",
        pricePerHour: 1800,
        area: 60,
        hasNaturalLight: false,
        hasCyclorama: true,
